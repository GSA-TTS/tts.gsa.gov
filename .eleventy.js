...
module.exports = function (config) {
  ...
  function getStateFromDates(opens, closes) {
    ...
    let now_string = DateTime.now().setZone('America/New_York').toFormat('yyyy-MM-dd');
    let opens_string = DateTime.fromJSDate(opens).setZone('America/New_York').toFormat('yyyy-MM-dd');
    let closes_string = DateTime.fromJSDate(closes).setZone('America/New_York').toFormat('yyyy-MM-dd');
